...
void relu_test()
{
    //vec z = linspace(-1,1,5);
    //vec s = z;
    //s.transform( [](double val){return val*(val > 0);});
    //z.print("z before = ");
    //s.print("s after = ");
    //vec y = z;
    //y.transform( [](double val){return (val > 0);});
    //y.print("y = ");
    //z.print("z after all = ");

    //vec y = z.transform( [](double val){return val*(val > 0);});
    //vec y_derivative = z.transform( [](double val){return (val > 0);});

    //z.print("z = ");
    //y.print("relu(z) = ");
    //y_derivative.print("relu_derivative(z) = ");
}
