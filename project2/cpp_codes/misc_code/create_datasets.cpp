...
int main(int argc, char const *argv[]) {
    create_frankefunction_binary_files();
...
{
    int N = 20000;
    char* filename = "frankefunction_dataset_N_20000_sigma_0.1.txt";
    ...
    x.save("frankefunction_x_20000_sigma_0.1.bin");
    y.save("frankefunction_y_20000_sigma_0.1.bin");
    z.save("frankefunction_z_20000_sigma_0.1.bin");
}
